...
<template>
  ...
  <div class="form-container">
    <form action="" class="container-principal">
    <div class="form-wrapper">
      ...
      <div class="form-fields">
        <div class="form-group">
          ...
          <input id="titulo" type="text" placeholder="Digite seu título..." />
        </div>

        <div class="form-group">
          <label for="descricao">Descrição</label>
          <textarea id="descricao" placeholder="Descreva seu projeto..."></textarea>
        </div>

        <div class="form-group">
          <label for="data-limite">Data Limite</label>
          <input id="data-limite" type="date" />
        </div>
        ...
        <div class="form-group">
          ...
          <input id="vagas" type="number" placeholder="Digite o total de vagas" />
        </div>

        <div class="form-group">
          <label for="salario">Salário</label>
          <input id="salario" type="number" placeholder="Digite o salário" />
        </div>
      </div>
    </div>
